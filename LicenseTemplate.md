This wiki page is intended to provide copy & paste template for Share Extras developers.

# License Header Templates #

You should place this code at the start of all relevant source files. This should include

  * All non-third-party client-side JavaScript files
...
Optionally, you can add your names as contributors within the class level JSDoc that normally appears after the license information, e.g.
...
Every Share Extras project must include a `COPYING.txt` file at the top level within the project, with the following contents.
