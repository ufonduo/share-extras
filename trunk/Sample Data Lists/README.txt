Sample Datalists for Alfresco Share
===================================

Author: Will Abson

This project defines a custom Book data list that can be used within Share, 
packaged as a JAR file for easy installation.
...
The command should build a JAR file named share-sample-datalists.jar
