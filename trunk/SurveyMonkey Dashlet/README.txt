...
This add-on for Alfresco Share defines a simple dashlet to display 
a SurveyMonkey survey on a site dashboard.
...
The command should build a JAR file named surveymonkey-dashlet.jar
