Google Site News dashlet for Alfresco Share
====================================
...
The command should build a JAR file named google-site-news-dashlet.jar
...
The dashlet will by default use the site name as its search term, and 
returnt what is most recently index with those term. As Site Administrator
you can configure the search terms, and the number of days to look back
from today in what is considered recent.
