...
public class ExecuteWebscript extends AbstractWebScript {
	 ...
	 */
	final public JavascriptConsoleResult executeScriptContent(WebScriptRequest req, WebScriptResponse res, ScriptContent scriptContent,
			String template, String spaceNodeRef, Map<String, String> urlargs) throws IOException {
